...
namespace AirTicketQuery.Modules.Code
{
    public static class ExtensionsHelpers
    {
        ...
        /// <summary>
        /// get string of src with yyyy/MM
        /// </summary>
        /// <param name="src">source date</param>
        /// <returns></returns>
        public static string ToYM(this DateTime src)
        {
            return src.ToString("yyyy/MM").Replace("-", "/");
        }
        ...
        public static string DescriptionValue(this Enum enumIns)
        {
            DescriptionAttribute attribute = enumIns.GetType()
                .GetField(enumIns.ToString())
                .GetCustomAttributes(typeof(DescriptionAttribute), false)
                .SingleOrDefault() as DescriptionAttribute;
            return attribute == null ? enumIns.ToString() : attribute.Description;
        }
        #endregion
    }
}
